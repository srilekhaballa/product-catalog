...
public class ProductPDFExporter {
    ...
    private void writeTableHeader(PdfPTable table) {
        ...
        cell.setPhrase(new Phrase("Updated By", font));
        table.addCell(cell);       
    }
    ...
    private void writeTableData(PdfPTable table) {
        for (Product product : listProducts) {
            ...
            table.addCell(product.getCreatedOn().toString());
            table.addCell(product.getCreatedBy());
            table.addCell(product.getUpdatedOn().toString());
            table.addCell(product.getUpdatedBy());
        }
    }
