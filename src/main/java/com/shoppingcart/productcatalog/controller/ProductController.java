...
public class ProductController {
	...
	public ResponseEntity<Integer> getCountProduct() {
		List<ProductDto> body = productService.listProducts();
		return new ResponseEntity<Integer>(body.size(), HttpStatus.OK);
	}

	@GetMapping("/getcountbycategory")
	public ResponseEntity<Query> getCountPerCategory() {
	...
	@GetMapping("/getcount/{category_id}")
	@ResponseBody 
	public ResponseEntity<Integer> getCountByCategoryId(@PathVariable("categoryId") Long id) throws Exception {
		Integer body = productRepository.countByCategoryId(id);
		return new ResponseEntity<Integer>(body,HttpStatus.OK);
	}
